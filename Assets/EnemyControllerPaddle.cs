...
public class EnemyControllerPaddle : MonoBehaviour
{
    ...
    public PlayerControllerPaddle playerPaddle;
    ...
    void Awake()
    {
        ...
        _playerControls.InGame.MoveEnemy.started += OnMoveEnemy_Started;
        _playerControls.InGame.MoveEnemy.performed += OnMoveEnemy_Performed;
        _playerControls.InGame.MoveEnemy.canceled += OnMoveEnemy_Canceled;

        GameObject playerPaddleObject = GameObject.Find("PaddlePlayer");
    ...
    private void Move()
    {
        ...
        moveInput = _playerControls.InGame.MoveEnemy.ReadValue<float>();
    ...
    private void OnMoveEnemy_Started(InputAction.CallbackContext context)
    {
        //move
        if (!isSliding)
        {
    ...
    private void OnMoveEnemy_Performed(InputAction.CallbackContext context)
    {
    ...
    private void OnMoveEnemy_Canceled(InputAction.CallbackContext context)
    {
        //Debug.Log(context);
        if (moveSpeed != 0)
        {
